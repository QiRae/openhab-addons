 ...
 */
@NonNullByDefault
public class TapoCloudDiscoveryService extends AbstractDiscoveryService implements ThingHandlerService {
    private final Logger logger = LoggerFactory.getLogger(TapoCloudDiscoveryService.class);
     ...
     * @param bridgeHandler
     */
    public TapoCloudDiscoveryService() {
